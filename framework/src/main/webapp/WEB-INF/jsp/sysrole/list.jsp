                ...
                <div class="box">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="btn-toolbar">
                                ...
                                <button type="button" class="btn btn-danger" id="btn-del"><i class="fa fa-remove"></i>
                                    批量删除
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="row-fluid" style="display:none;" id="div-advanced-search">
                        <form class="form-inline well">
                            <span>角色名称:</span>
                            <input type="text" class="input-medium" placeholder="角色名称" id="name-search">
                            <span>角色代码:</span>
                            <input type="text" class="input-medium" placeholder="角色代码" id="role-search">
                            <span>状态:</span>
                            <select class="input-small" id="available-search">
                            ...
                            <button type="button" class="btn" id="btn-advanced-search"><i class="fa fa-search"></i> 查询
                            </button>
                        </form>
                    </div>
                    <!-- 模糊查询 end -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/datatables/sysrole.js"></script>
