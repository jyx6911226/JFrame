...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<div class="box">
						...
						<div class="row-fluid" style="display: none;"
							...
							<form class="form-inline well">
								<span>角色名称:</span> <input type="text" class="input-medium"
									placeholder="角色名称" id="name-search"> <span>角色代码:</span>
								<input type="text" class="input-medium" placeholder="角色代码"
									id="role-search"> <span>状态:</span> <select
									class="input-small" id="available-search">
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/datatables/sysrole.js"></script>
	<script type="text/javascript"
