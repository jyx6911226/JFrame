...
<div>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/sysRole/initAdd"> 角色添加</a></li>
        ...
        <div class="box box-info">
            <form id="defaultForm" action="#" method="post">
                ...
                <div class="form-group">
                    <label>名称</label>
                    <input type="text" id = "role_name" name="name" class="form-control" placeholder="名称">
                    <span class="form-control-feedback"></span>
                </div>
                <div class="form-group">
                    <label>标识</label>
                    <input type="text" id="role_code" name="role" class="form-control" placeholder="标识">
                    <span class="form-control-feedback"></span>
                </div>

                <div class="form-group">
                    <label>描述</label>
                    <input type="text" id="role_description" name="description" class="form-control" placeholder="描述">
                    <span class="form-control-feedback"></span>
                </div>
                <div class="form-group">
                    <label>状态</label>
                ...
                name: {/*键名name和input name值对应*/
                    ...
                    validators: {
                        ...
                        remote:{
                            ...
                            data:{ id: function() {return $("#role_id").val();}},
                            delay: 2000
                        }
                    }
                },
