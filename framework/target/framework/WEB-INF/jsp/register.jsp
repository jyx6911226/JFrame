  ...
  <div class="register-box-body">
    ...
    <form id="defaultForm" action="${pageContext.request.contextPath}/register/add" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="username" class="form-control" placeholder="<spring:message code="register.username" />">
...
<%--       <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="password" class="form-control" placeholder="<spring:message code="register.password" />">
        <span class="form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="repeat_password" class="form-control" placeholder="<spring:message code="register.repeat_password" />">
        <span class="form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="terms"><spring:message code="register.I_agree" /> <a href="#"><spring:message code="register.terms" /></a>
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat"><spring:message code="register.register" /></button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!--<div class="social-auth-links text-center">
    ...
    <a href="${pageContext.request.contextPath}/login" class="text-center"><spring:message code="register.have_membership" /></a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
...
<!-- iCheck -->
<script type="text/javascript" src="${pageContext.request.contextPath}/AdminLTE-2.3.7/plugins/iCheck/icheck.min.js"></script>
<!-- bootstrapValidator -->
