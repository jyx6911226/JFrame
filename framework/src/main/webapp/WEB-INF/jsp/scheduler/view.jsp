...
<div>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/scheduler/initList"> 任务管理</a></li>
            <li><a href="${pageContext.request.contextPath}/scheduler/initView/${obj.id}"> 任务查看</a></li>
        </ol>
    </section>
    <div class="col-md-12">
        <div class="box box-info">
            <div class="col-md-6">
                <div class="form-group">
                     <label>名称</label>
                     <input type="text" id="sysscheduler_name" name="name" value="${obj.name}" class="form-control"
                            placeholder="名称" disabled>
                     <span class="form-control-feedback"></span>
                 </div>
                 <div class="form-group">
                     <label>任务类</label>
                     <input type="text" id="sysscheduler_jobClass" name="code" value="${obj.jobClass}" class="form-control"
                            placeholder="任务类" disabled>
                     <span class="form-control-feedback"></span>
                 </div>
                 <div class="form-group">
                     <label>表达式</label>
                     <input type="text" id="sysscheduler_cron" name="code" value="${obj.cron}" class="form-control"
                           placeholder="表达式" disabled>
                     <span class="form-control-feedback"></span>
                 </div>
                 <div class="form-group">
                     <label>运行状态</label>
                     <input type="text" id="sysscheduler_startFlag" name="code" value="${obj.startFlag}" class="form-control"
                           placeholder="表达式" disabled>
                     <span class="form-control-feedback"></span>
                 </div>
                 <div class="form-group">
                     <label>任务参数</label>
                     <input type="text" id="sysscheduler_jobParams" name="code" value="${obj.jobParams}" class="form-control"
                           placeholder="任务参数" disabled>
                     <span class="form-control-feedback"></span>
                 </div>
                 <div class="form-group">
                    <label>任务说明</label>
                    <input type="text" id="sysscheduler_notes" name="code" value="${obj.notes}" class="form-control"
                           placeholder="任务说明" disabled>
                    <span class="form-control-feedback"></span>
                 </div>
            </div>
        </div>
