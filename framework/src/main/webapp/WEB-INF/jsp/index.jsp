...
<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
    ...
    -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/AdminLTE-2.3.7/dist/css/skins/skin-blue.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="${pageContext.request.contextPath}/index" class="logo">
				...
				class="logo-mini"><b>J</b></span> <!-- logo for regular state and mobile devices -->
					...
					<ul class="nav navbar-nav">
										...
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<!-- User Image -->
													<img
														src="${pageContext.request.contextPath}/AdminLTE-2.3.7/dist/img/user2-160x160.jpg"
						...
						<li class="dropdown user user-menu">
							...
							data-toggle="dropdown"> <!-- The user image in the navbar-->
								...
								<span class="hidden-xs"><shiro:principal
            ...
            <form action="#" method="get" class="sidebar-form">
              <div class="input-group">
				...
				<ul class="sidebar-menu">
					...
					<shiro:hasPermission name="scheduler">
					<li class="treeview"><a href="#"><i class="fa fa-link"></i><span>系统任务</span>
						<span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
							</span> </a>
						<ul class="treeview-menu">
							<shiro:hasPermission name="SysScheduler">
								<li><a
		...
		<footer class="main-footer">
			...
			<!-- Default to the left -->
			<strong>Copyright &copy; 2016 <a href="#">NONO</a>.
	...
	<!-- AdminLTE App -->
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/AdminLTE-2.3.7/dist/js/app.min.js"></script>
